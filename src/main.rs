...
impl Model {
    fn with_demo(demo: Demo) -> Self {
        match demo {
            ...
            Demo::Chap8Demo2 => Model {
                render: bindings::chap8_demo2,
                view: view_chap8_demo2,
                view_id: "chap8-demo2".to_string(),
            },
            Demo::Chap8Demo3 => Model {
                render: bindings::chap8_demo3,
            ...
            Demo::Chap9Demo3 => Model {
                render: bindings::chap9_demo3,
...
fn view_dropdown() -> Node<Msg> {
    select![
        ...
        optgroup![
            ...
            option![
                Demo::Chap8Demo2.to_string(),
                ev(Ev::Click, |_| Msg::Select(Demo::Chap8Demo2))
            ],
            option![
...
fn view_chap8_demo2(model: &Model) -> Vec<Node<Msg>> {
    nodes![
        div![
            id![&model.view_id],
            style! {
        ...
        div![
            ...
            pre!(include_str!("./js/chap8_demo2.js")),
        ],
    ]
}

fn view_chap8_demo3(model: &Model) -> Vec<Node<Msg>> {
    nodes![
        div![
            id![&model.view_id],
            style! {
...
fn view_chap9_demo3(model: &Model) -> Vec<Node<Msg>> {
    nodes![
        div![
            id![&model.view_id],
            style! {
